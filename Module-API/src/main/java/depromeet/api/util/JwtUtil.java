...
public class JwtUtil {
    ...
    public String generateToken(User user) {
        return doGenerateToken(user.getSocial().getId(), TOKEN_VALIDATION_SECOND, user.getRole());
    }

    public String generateRefreshToken(User user) {
        return doGenerateToken(
                user.getSocial().getId(), REFRESH_TOKEN_VALIDATION_SECOND, user.getRole());
    }

    public String doGenerateToken(String socialId, long expireTime, Role role) {
